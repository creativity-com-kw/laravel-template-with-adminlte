    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">Coaches</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.users.coaches.create') }}" class="btn btn-sm bg-gradient-primary float-right"><i class="fas fa-plus"></i>&nbsp; Add New</a>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.users.coaches.index') }}',
                    dataType: 'json',
                    type: 'GET',
                    data: function (d) {
