                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.users.coaches.store') }}" role="form" autocomplete="off" enctype="multipart/form-data" id="form" class="needs-validation">
                                @csrf
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="coach_type" class="form-control @error('coach_type') is-invalid @enderror">
                                                    ...
                                                    <option value="1" {{ old('coach_type') == '1' ? 'selected' : null }}>Full-Time</option>
                                                    <option value="2" {{ old('coach_type') == '2' ? 'selected' : null }}>Part-Time</option>
                                                    <option value="3" {{ old('coach_type') == '3' ? 'selected' : null }}>Freelancer</option>
                                                </select>
