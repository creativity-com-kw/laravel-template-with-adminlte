                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.users.coaches.index') }}">Coaches</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <form id="remove-image-form" action="{{ route('admin.users.coaches.avatar.delete', [$user]) }}" method="POST" style="display: none;">
                                @csrf
                                @method('delete')
                            </form>

                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.users.coaches.update', [$user]) }}" role="form" autocomplete="off" enctype="multipart/form-data" id="form" class="needs-validation">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select name="coach_type" class="form-control @error('coach_type') is-invalid @enderror">
                                                    <option value="">Select Position</option>
                                                    <option value="1" {{ $user->coach_type == '1' ? 'selected' : null }}>Full-Time</option>
                                                    <option value="2" {{ $user->coach_type == '2' ? 'selected' : null }}>Part-Time</option>
                                                    <option value="3" {{ $user->coach_type == '3' ? 'selected' : null }}>Freelancer</option>
                                                </select>
