                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline card-primary">
                            <form method="POST" action="{{ route('admin.m3.classes.schedule.store', $class) }}" role="form" id="addScheduleForm" class="needs-validation" autocomplete="off">
                                @csrf
                                            ...
                                            <div class="well m-b-15 p-l-15 p-t-10 p-r-15 p-b-10">
                                                ...
                                                @if (in_array(0,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="sunday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                                                ...
                                                @if (in_array(1,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="monday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                                                ...
                                                @if (in_array(2,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="tuesday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                                                ...
                                                @if (in_array(3,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="wednesday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                                                ...
                                                @if (in_array(4,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="thursday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                                                ...
                                                @if (in_array(5,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="friday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                                                ...
                                                @if (in_array(6,$working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>Seats</label>
                                                            <input type="number" name="saturday_num_seats" value="{{ $class->num_seats }}" min="0" class="form-control">
                                                        </div>
                ...
                <form method="POST" role="form" id="editScheduleForm" class="needs-validation">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label>Seats</label>
                                <input type="number" name="num_seats" value="" min="0" class="form-control">
                            </div>
        ...
        $(document).ready(function () {
            ...
            var validator = $('#addScheduleForm').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: '{{ route('admin.m3.classes.schedule.store', $class) }}',
                        type: 'POST',
                        data: data,
            ...
            function populateForm(data) {
                ...
                $('[name="num_seats"]').val(data.num_seats);
            ...
            var table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.m3.classes.schedule.index',$class) }}',
                    dataType: 'json',
                    type: 'GET',
                    data: function (d) {
