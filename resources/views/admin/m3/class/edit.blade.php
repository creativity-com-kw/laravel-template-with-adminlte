                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <form id="remove-image-form" action="{{ route('admin.m3.classes.image.delete', [$class]) }}" method="POST" style="display: none;">
                                @csrf
                                @method('delete')
                            </form>

                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.m3.classes.update', [$class]) }}" role="form" autocomplete="off" enctype="multipart/form-data" id="form" class="needs-validation">
                                @csrf
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-6">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img src="{{ $class->image_url }}" onerror="this.onerror=null; this.src='{{ asset('themes/AdminLTE/dist/img/default-1000x1000.png') }}';" id="profile_img" class="rounded mb-2" width="300" height="auto"  alt=""/>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="num_seats" value="{{ $class->num_seats }}" min="0" class="form-control @error('num_seats') is-invalid @enderror">
