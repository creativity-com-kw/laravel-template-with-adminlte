                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">Group Classes</li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.m3.packages.index') }}">Packages</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary card-outline">
                            <form id="remove-image-form" action="{{ route('admin.m3.packages.image.delete', [$package]) }}" method="POST" style="display: none;">
                                @csrf
                                @method('delete')
                            </form>

                            <!-- form start -->
                            <form method="POST" action="{{ route('admin.m3.packages.update', [$package]) }}" role="form" autocomplete="off" enctype="multipart/form-data" id="form" class="needs-validation">
                                @csrf
