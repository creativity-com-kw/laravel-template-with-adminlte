<div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li><a class="dropdown-item" href="{{ route('admin.m3.packages.edit', [$package]) }}">Edit</a></li>
        @if(!$package->trashed())
...
<form method="POST" action="{{ route('admin.m3.packages.destroy', [$package]) }}" id="delete-form-{{ $package->id }}" style="display: none;">
    @csrf
    @method('DELETE')
</form>

<form method="POST" action="{{ route('admin.m3.packages.restore', [$package]) }}" id="restore-form-{{ $package->id }}" style="display: none;">
    @csrf
    @method('PUT')
</form>
