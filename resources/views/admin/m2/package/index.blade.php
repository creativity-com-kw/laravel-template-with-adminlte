        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row align-items-center mt-2">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.m2.packages.create') }}" class="btn btn-sm bg-gradient-primary float-right"><i class="fas fa-plus"></i>&nbsp; Add New</a>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.m2.packages.index') }}',
                    dataType: 'json',
                    type: 'GET',
                    data: function (d) {
