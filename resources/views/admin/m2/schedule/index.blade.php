    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">Schedule</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-outline card-primary">
                            <form method="POST" action="{{ route('admin.m2.schedule.store') }}" role="form" id="addScheduleForm" class="needs-validation" autocomplete="off">
                                @csrf
                                            ...
                                            <div class="well m-b-15 p-l-15 p-t-10 p-r-15 p-b-10">
                                                ...
                                                @if (in_array(0, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="sunday_coach">
                                                            <label>Coach</label>
                                                            <select name="sunday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                ...
                                                @if (in_array(1, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="monday_coach">
                                                            <label>Coach</label>
                                                            <select name="monday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                                @foreach ($coaches as $item)
                                                                    <option value="{{ $item['id'] }}">{{ $item['first_name'] }}</option>
                                                                @endforeach
                                                ...
                                                @if (in_array(2, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="tuesday_coach">
                                                            <label>Coach</label>
                                                            <select name="tuesday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                                @foreach ($coaches as $item)
                                                                    <option value="{{ $item['id'] }}">{{ $item['first_name'] }}</option>
                                                                @endforeach
                                                ...
                                                @if (in_array(3, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="wednesday_coach">
                                                            <label>Coach</label>
                                                            <select name="wednesday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                                @foreach ($coaches as $item)
                                                                    <option value="{{ $item['id'] }}">{{ $item['first_name'] }}</option>
                                                                @endforeach
                                                ...
                                                @if (in_array(4, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="thursday_coach">
                                                            <label>Coach</label>
                                                            <select name="thursday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                                @foreach ($coaches as $item)
                                                                    <option value="{{ $item['id'] }}">{{ $item['first_name'] }}</option>
                                                                @endforeach
                                                ...
                                                @if (in_array(5, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="friday_coach">
                                                            <label>Coach</label>
                                                            <select name="friday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                                @foreach ($coaches as $item)
                                                                    <option value="{{ $item['id'] }}">{{ $item['first_name'] }}</option>
                                                                @endforeach
                                                ...
                                                @if (in_array(6, $working_days))
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4" id="saturday_coach">
                                                            <label>Coach</label>
                                                            <select name="saturday_coach[]" multiple class="form-control js-select2">
{{--                                                                <option Inactive value="">Select Coach</option>--}}
                                                                @foreach ($coaches as $item)
                                                                    <option value="{{ $item['id'] }}">{{ $item['first_name'] }}</option>
                                                                @endforeach
        ...
        $(document).ready(function () {
            ...
            var validator = $('#addScheduleForm').validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: '{{ route('admin.m2.schedule.store') }}',
                        type: 'POST',
                        data: data,
            ...
            var table = $('#table').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.m2.schedule.index') }}',
                    dataType: 'json',
                    type: 'GET',
                    data: function (d) {
