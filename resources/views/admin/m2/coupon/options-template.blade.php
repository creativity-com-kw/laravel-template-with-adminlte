<div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li><a class="dropdown-item" href="{{ route('admin.m2.coupons.edit', [$coupon]) }}">Edit</a></li>
        @if(!$coupon->trashed())
...
<form method="POST" action="{{ route('admin.m2.coupons.destroy', [$coupon]) }}" id="delete-form-{{ $coupon->id }}" style="display: none;">
    @csrf
    @method('DELETE')
</form>

<form method="POST" action="{{ route('admin.m2.coupons.restore', [$coupon]) }}" id="restore-form-{{ $coupon->id }}" style="display: none;">
    @csrf
    @method('PUT')
</form>
